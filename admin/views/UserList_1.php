...
-->
											...
											<tr>
												...
												<td>
													<p><?php if(isset($userName) && $userName != '')	echo trim($userName); else echo '-';?></p>
													<p><?php if(isset($value->cardCount) && $value->cardCount > 1){ ?> 
														...
														<?php }else echo '<p><br>Card : 1<br></p>';?>
														</p>
												</td>
<!--
...
-->
												...
												<td><?php 	if(isset($value->FacebookId) && $value->FacebookId != ''	&&	isset($value->TwitterId) && $value->TwitterId != '')
															{ ?>
																<p><b>FB : </b><?php echo $value->FacebookId;?></p>
																<p><b>Twitter : </b><?php echo $value->TwitterId;?></p>
													<?php 	}else if(isset($value->FacebookId) && $value->FacebookId != ''){?>
																<p><b>FB : </b><?php echo $value->FacebookId;?></p>
													<?php 	}else if(isset($value->TwitterId) && $value->TwitterId != ''){?>
																<p><b>Twitter : </b><?php echo $value->TwitterId;?></p>
													<?php 	}?>
															</td>
<!--
...
<td align="center"><a href="UserInterest?uid=<?php if(isset($value->id) && $value->id != '') echo $value->id; ?>" class="interest_pop_up cboxElement"  alt="Interest" title="Interest" ><img src="<?php echo ADMIN_IMAGE_PATH; ?>chat_images.png" width="18" height="14" alt=""></a></td>
