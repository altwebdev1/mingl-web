							...
							<div class="left_menu sidebar-nav" style="float:left;"><?php side_bar()?></div>
						 	 <div id="content_3" class="content">
						  		 <table align="center" cellpadding="0" cellspacing="0" border="0"  width="100%">
									...
									<tr><td colspan="9"><div class="box-header"><h2><i class="icon_add_service"></i><?php if(isset($process) && $process != '' ) { echo 'View Service - '.$process; } else echo 'View Service'?></h2></td></td></tr></div>
